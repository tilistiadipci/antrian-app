...
-- Dumping structure for table antrian_app_2.calls
...
-- Dumping data for table antrian_app_2.calls: ~0 rows (approximately)

-- Dumping structure for table antrian_app_2.channels
...
-- Dumping data for table antrian_app_2.channels: ~0 rows (approximately)

-- Dumping structure for table antrian_app_2.counters
...
-- Dumping data for table antrian_app_2.counters: ~4 rows (approximately)
...
-- Dumping structure for table antrian_app_2.departments
...
-- Dumping data for table antrian_app_2.departments: ~2 rows (approximately)
...
-- Dumping structure for table antrian_app_2.guests
...
-- Dumping data for table antrian_app_2.guests: ~4 rows (approximately)
...
-- Dumping structure for table antrian_app_2.languages
...
-- Dumping data for table antrian_app_2.languages: ~13 rows (approximately)
...
-- Dumping structure for table antrian_app_2.members
...
-- Dumping data for table antrian_app_2.members: ~0 rows (approximately)

-- Dumping structure for table antrian_app_2.messages
...
-- Dumping data for table antrian_app_2.messages: ~0 rows (approximately)

-- Dumping structure for table antrian_app_2.migrations
...
-- Dumping data for table antrian_app_2.migrations: ~21 rows (approximately)
...
-- Dumping structure for table antrian_app_2.mobiles
...
-- Dumping data for table antrian_app_2.mobiles: ~1 rows (approximately)
...
-- Dumping structure for table antrian_app_2.password_resets
...
-- Dumping data for table antrian_app_2.password_resets: ~0 rows (approximately)

-- Dumping structure for table antrian_app_2.queues
...
-- Dumping data for table antrian_app_2.queues: ~0 rows (approximately)

-- Dumping structure for table antrian_app_2.rattings
...
-- Dumping data for table antrian_app_2.rattings: ~0 rows (approximately)

-- Dumping structure for table antrian_app_2.sales
...
-- Dumping data for table antrian_app_2.sales: ~0 rows (approximately)

-- Dumping structure for table antrian_app_2.settings
...
-- Dumping data for table antrian_app_2.settings: ~1 rows (approximately)
...
-- Dumping structure for table antrian_app_2.templates
...
-- Dumping data for table antrian_app_2.templates: ~1 rows (approximately)
...
-- Dumping structure for table antrian_app_2.users
...
-- Dumping data for table antrian_app_2.users: ~3 rows (approximately)
