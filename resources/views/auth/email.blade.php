        ...
        <div id="login-page" class="row">
            <div class="col s12 z-depth-4 card-panel">
                <form class="login-form" action="{{ route('post_email') }}" method="post" onsubmit="return load()">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <button type="submit" class="btn waves-effect waves-light col s12" style="background:{{ $settings->background_menu }};color:{{ $settings->color }};">Send Password Reset Link</button>
                        </div>
                    </div>
                    <div class="row">
