                ...
                <form class="login-form" action="{{ route('post_login') }}" method="post" onsubmit="return load()">
                    ...
                    <div class="row">
                        <div class="input-field col s12 center">
                            <p class="center login-form-text" style="font-size:23px;margin-top:5px"><img src="{{ asset('assets/images') }}/{{ $settings->logo }}" width="150" class="brand-logo-a responsive-img"></p>
                            <p class="center login-form-text" style="letter-spacing:1px">Silahkan login untuk melanjutkan</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <button type="submit" class="btn waves-effect waves-light col s12" style="background:{{ $settings->background_menu }};color:{{ $settings->color }};">Log in</button>
                        </div>
                    </div>
                    <div class="row">
