...
@endif    
    ...
    @can('access', \App\Models\User::class)
        <li class="bold{!! Request::is('templates*') ? ' active' : '' !!}"><a href="{{ url('templates') }}" class="waves-effect waves-cyan truncate">
            <i class="mdi-action-view-quilt"></i> Template Display</a>
        </li>
        <li>
