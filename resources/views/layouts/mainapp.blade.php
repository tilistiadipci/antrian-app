            ...
            <div class="navbar-fixed">
                <nav class="navbar-color" style="background:{{ $background_menu }};">
                    <div class="nav-wrapper">
                        <ul class="left">
                            <li><h1 class="logo-wrapper"><span class="brand-logo darken-1">{{ $company_name }}</span></h1></li>
                        </ul>
                        ...
                        <ul id="notifications-dropdown" class="dropdown-content">
                            ...
                            <li><a href="{{ route('display') }}/1" target="_blank" style="font-weight:400">Display 2</a></li>
