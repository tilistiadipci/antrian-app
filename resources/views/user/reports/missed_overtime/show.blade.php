                            ...
                            <select id="counter" class="browser-default">
                                @if(is_object($scounter))
                                    ...
                                    @foreach($counters as $counter)
                                        <option value="{{ $counter->id }}"{!! $counter->id==$scounter->id?' selected':'' !!}>{{ $counter->name }} {{ $counter->idcounter }}</option>
                                    @endforeach
                                @else
