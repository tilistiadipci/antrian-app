      ...
      <div class="container">
        ...
        <div class="header-content position-relative d-flex align-items-center justify-content-between">
          ...
          <div class="chat-user--info d-flex align-items-center">
            <!-- Back Button -->
            <div class="back-button"><a href="{{ route('stafchathome') }}">
    ...
    <div class="chat-footer">
      <div class="container h-100">
        <div class="chat-footer-content h-100 d-flex align-items-center">
          <form action="{{ route('sendchatstaf',$id) }}" method="post">
            {{ csrf_field() }}
            <!-- Message -->
            <input class="form-control" id="message" name="message" type="text" placeholder="Type here...">
            <input class="form-control" id="admin_id" name="admin_id" value="{{ $user->id }}" type="hidden" >
            <input class="form-control" id="member_id" name="member_id" value="{{ $id }}" type="hidden" >
            <!-- Send -->
