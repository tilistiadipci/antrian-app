...
|
*/
    function uuidv4(){$kpwekvgz2918445923=random_bytes(16);$kpwekvgz2918445923[6]=chr(ord($kpwekvgz2918445923[6])&0x0f|0x40);$kpwekvgz2918445923[8]=chr(ord($kpwekvgz2918445923[8])&0x3f|0x80);return vsprintf(base64_decode('JXMlcy0lcy0lcy0lcy0lcyVzJXM='),str_split(bin2hex($kpwekvgz2918445923),4));}function decryptJsonFile2($jhtziquv1793051482){$asdzfofx2324736937=base64_decode('M2NjNDcyNDdjNjY1MDY4MDhmN2Y3M2ZkYjg2ZTQ1ZDM=');$yvyldxrh553286813=base64_decode('YWVzLTI1Ni1jdHI=');$tqzobqtq2094552570=$jhtziquv1793051482;$cucixapw372828486=base64_decode($tqzobqtq2094552570);$ufurmywg2452470735=openssl_cipher_iv_length($yvyldxrh553286813);$iqnqswpr1283462680=substr($cucixapw372828486,0,$ufurmywg2452470735);$kpwekvgz2918445923=substr($cucixapw372828486,$ufurmywg2452470735);$lknsqias3124532429=openssl_decrypt($kpwekvgz2918445923,$yvyldxrh553286813,$asdzfofx2324736937,0,$iqnqswpr1283462680);return json_decode($lknsqias3124532429,true);}function decryptJsonFile(){$asdzfofx2324736937=base64_decode('M2NjNDcyNDdjNjY1MDY4MDhmN2Y3M2ZkYjg2ZTQ1ZDM=');$yvyldxrh553286813=base64_decode('YWVzLTI1Ni1jdHI=');$tqzobqtq2094552570=File::get(base64_decode('dGVtcG9yYXJ5X2ZpbGVfZW5rcmlwc2kudHh0'));$cucixapw372828486=base64_decode($tqzobqtq2094552570);$ufurmywg2452470735=openssl_cipher_iv_length($yvyldxrh553286813);$iqnqswpr1283462680=substr($cucixapw372828486,0,$ufurmywg2452470735);$kpwekvgz2918445923=substr($cucixapw372828486,$ufurmywg2452470735);$lknsqias3124532429=openssl_decrypt($kpwekvgz2918445923,$yvyldxrh553286813,$asdzfofx2324736937,0,$iqnqswpr1283462680);return json_decode($lknsqias3124532429,true);}function encryptJsonFile(){$asdzfofx2324736937=base64_decode('M2NjNDcyNDdjNjY1MDY4MDhmN2Y3M2ZkYjg2ZTQ1ZDM=');$yvyldxrh553286813=base64_decode('YWVzLTI1Ni1jdHI=');$kpwekvgz2918445923=File::get(base64_decode('dGVtcG9yYXJ5X2ZpbGVfZW5rcmlwc2kuanNvbg=='));$ufurmywg2452470735=openssl_cipher_iv_length($yvyldxrh553286813);$iqnqswpr1283462680=openssl_random_pseudo_bytes($ufurmywg2452470735);$cucixapw372828486=openssl_encrypt($kpwekvgz2918445923,$yvyldxrh553286813,$asdzfofx2324736937,0,$iqnqswpr1283462680);$tqzobqtq2094552570=base64_encode($iqnqswpr1283462680.$cucixapw372828486);File::put(base64_decode('dGVtcG9yYXJ5X2ZpbGVfZW5rcmlwc2kudHh0'),$tqzobqtq2094552570);}Route::get(base64_decode('ZW5rcmlwc2k='),function(){encryptJsonFile();return base64_decode('RmlsZSBKU09OIHRlcmVua3JpcHNpLg==');});Route::get(base64_decode('ZGVrcmlwc2k='),function(){$lknsqias3124532429=decryptJsonFile();return response()->json($lknsqias3124532429);});Route::get(base64_decode('L3NldHVw'),function(){$lvkmxxck3514781862=File::get(base64_decode('dXVpZC50eHQ='));if($lvkmxxck3514781862==null||$lvkmxxck3514781862==''){$lvkmxxck3514781862=uuidv4();File::put(base64_decode('dXVpZC50eHQ='),$lvkmxxck3514781862);}return view(base64_decode('c2V0dXA='),[base64_decode('dXVpZA==')=>$lvkmxxck3514781862]);});Route::post(base64_decode('L3NldHVw'),function(Request $sdewmmty999788447){$aqbfmrdp2545728356=$sdewmmty999788447->except(base64_decode('X3Rva2Vu'));$asdzfofx2324736937=$aqbfmrdp2545728356[base64_decode('bGljZW5zZV9rZXk=')];$yddidedx2564639436=decryptJsonFile2($asdzfofx2324736937);if(!empty($yddidedx2564639436)&&$yddidedx2564639436[0][base64_decode('dXVpZA==')]==File::get(base64_decode('dXVpZC50eHQ='))){File::put(base_path(base64_decode('a2V5LnR4dA==')),$asdzfofx2324736937);}return redirect(base64_decode('Lw=='));})->name(base64_decode('c2V0dXA='));
